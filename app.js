...
game.party.forEach (poke => {
  console.log(`Exercise 8`, poke.name)
})
...
*/
game.catchPokemon = function (poke) {
...
*/
game.gymStatus = () => {
  // creating the gymTally objects
  const gymTally = {
    completed: 0,
    incomplete: 0
  }
  // We are looping thru the gyms to check their status
   game.gyms.forEach(gym => {
